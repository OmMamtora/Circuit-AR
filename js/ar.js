...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function startScanner() {
        ...
        html5QrCode = new Html5Qrcode("qr-reader", {
            ...
            experimentalFeatures: { useBarCodeDetectorIfSupported: true }, // uses the phone's native, much faster decoder when available
            verbose: false
        });
        ...
        const config = {
            ...
            videoConstraints: {
                facingMode: "environment",
                advanced: [{ focusMode: "continuous" }] // keeps refocusing instead of locking onto the wrong distance
            }
        };
